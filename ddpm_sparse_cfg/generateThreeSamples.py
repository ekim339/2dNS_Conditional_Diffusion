...
def _add_sparse_grid_lines(ax, stride: int = 8, n: int = 64):
    """Dashed lines for coarse 8×8 sensor grid on 64×64 fields."""
...
def compare_train_and_test_samples(
    ...
    samples_dir = "/Users/eugenekim/2dNS_Conditional_Diffusion/ddpm_sparse_cfg/samples"
    os.makedirs(samples_dir, exist_ok=True)
    train_save = os.path.join(samples_dir, "train_samples_3x3.png")
    test_save = os.path.join(samples_dir, "test_samples_3x3.png")
...
if __name__ == "__main__":
    # Configuration
    ckpt_path = "/Users/eugenekim/2dNS_Conditional_Diffusion/checkpoint/newDiffusion.pt"
