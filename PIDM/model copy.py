...
def run_ground_truth_physics_baseline(
    ...
    if isinstance(data, np.ndarray):
        ...
        raise TypeError("data must be numpy array or torch tensor of shape (N, 64, 64)")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data",
        type=str,
        default=os.path.join(_PROJECT_ROOT, "NSE_Data(Noisy).npy"),
        help="Path to (N, 64, 64) vorticity numpy file.",
    )
    parser.add_argument(
        "--split",
        type=str,
